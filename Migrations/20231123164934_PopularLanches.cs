...
namespace Ecommerce.Migrations
{
    public partial class PopularLanches : Migration
    {
        ...
        {
            //Usamos o DELETE FROM para excluirmos um items
